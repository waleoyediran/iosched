...
package org.gdays.apps.conference;
...
public class Config {
    ...
    // Conference hashtag
    public static final String CONFERENCE_HASHTAG = "#gdays14";
    ...
    public static final String CONFERENCE_HASHTAG_PREFIX = "#gdays14";
    ...
    // YouTube API config
    public static final String YOUTUBE_API_KEY = "AIzaSyCt3eT1_exHKXpwZQdhZvTlFSHWlvUOJjM";
