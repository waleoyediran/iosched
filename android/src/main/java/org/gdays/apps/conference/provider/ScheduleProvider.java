...
package org.gdays.apps.conference.provider;

import org.gdays.apps.conference.appwidget.ScheduleWidgetProvider;
import org.gdays.apps.conference.provider.ScheduleContract.Announcements;
import org.gdays.apps.conference.provider.ScheduleContract.PeopleIveMet;
import org.gdays.apps.conference.provider.ScheduleContract.Blocks;
import org.gdays.apps.conference.provider.ScheduleContract.Experts;
import org.gdays.apps.conference.provider.ScheduleContract.Feedback;
import org.gdays.apps.conference.provider.ScheduleContract.MapMarkers;
import org.gdays.apps.conference.provider.ScheduleContract.MapTiles;
import org.gdays.apps.conference.provider.ScheduleContract.Rooms;
import org.gdays.apps.conference.provider.ScheduleContract.SearchSuggest;
import org.gdays.apps.conference.provider.ScheduleContract.Sessions;
import org.gdays.apps.conference.provider.ScheduleContract.Speakers;
import org.gdays.apps.conference.provider.ScheduleContract.Tags;
import org.gdays.apps.conference.provider.ScheduleDatabase.SessionsSearchColumns;
import org.gdays.apps.conference.provider.ScheduleDatabase.SessionsSpeakers;
import org.gdays.apps.conference.provider.ScheduleDatabase.Tables;
import org.gdays.apps.conference.util.SelectionBuilder;
...
import org.gdays.apps.conference.Config;
import org.gdays.apps.conference.provider.ScheduleContract.*;
import org.gdays.apps.conference.util.AccountUtils;
...
import static org.gdays.apps.conference.util.LogUtils.LOGD;
import static org.gdays.apps.conference.util.LogUtils.LOGV;
import static org.gdays.apps.conference.util.LogUtils.makeLogTag;

/**
 * Provider that stores {@link ScheduleContract} data. Data is usually inserted
 * by {@link org.gdays.apps.conference.sync.SyncHelper}, and queried by various
